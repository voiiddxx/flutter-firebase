...
class NonTechnichalEventScreen extends StatefulWidget {
  const NonTechnichalEventScreen({super.key});

  @override
  State<NonTechnichalEventScreen> createState() => _TechEventScreenState();
}

class _TechEventScreenState extends State<NonTechnichalEventScreen> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          " Non Tech Events",
          style: TextStyle(
              color: Color.fromARGB(255, 41, 255, 162),
